...
class VideoSource_Yahoo
{
	...
	public static function renderYahooPlayer($options, $width, $height, &$videolist_row, &$theme_row)
	{
		...
		$result='<object width="'.$width.'" height="'.$height.'">'
			.'<param name="movie" value="http://d.yimg.com/static.video.yahoo.com/yep/YV_YEP.swf?ver=3.5.36" />'
			...
			.'<embed src="http://d.yimg.com/static.video.yahoo.com/yep/YV_YEP.swf?ver=3.5.36" '
