...
(function($) {
	...
	$sk.fn.extend({
		...
		setup: function() 
		{
			...
			this.box_skitter.find('.container_skitter').width(this.settings.width_skitter).height(this.settings.height_skitter);
			...
			this.box_skitter.find('ul.skitter-data').remove();
		...
		enableResize: function() {
			...
			$(window).resize(function(){
				...
				self.box_skitter.find('.container_skitter').css({'width':sliderWidth, 'height': self.settings.height_skitter});
	      });
		},
