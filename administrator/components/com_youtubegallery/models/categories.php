		...
		function ConfirmRemove()
        {
				...
				if (count( $cids ))
				{
						...
						else
						{
								...
								echo '<p style="font-weight:bold;"><a href="'.$cancellink.'">'.JText::_( 'COM_YOUTUBEGALLERY_NO_CANCEL' ).'</a></p>
...
';
		...
		/*protected function renderCatgoryListWithChildren()
		{
				echo '<li>'.$row->categryname;
								echo '</li>';
		}*/
